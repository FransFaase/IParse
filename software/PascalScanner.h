#ifndef _INCLUDED_PASCALSCANNER_H
#define _INCLUDED_PASCALSCANNER_H

#include "Scanner.h"

class PascalScanner : public AbstractScanner
{
public:
...
private:
	...
	bool accept_uint(TextFileBuffer& text, AbstractParseTree& result);
...
#endif // _INCLUDED_PASCALSCANNER_H
