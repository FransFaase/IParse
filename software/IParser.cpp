...
bool IParser::parse_term( GrammarTerminal* term, AbstractParseTree &rtree )
{
...
bool IParser::parse_ws_term( GrammarTerminal* term )
{
	TextFilePos start_pos = _text;
...
bool IParser::parse_ident(GrammarIdent* ident, AbstractParseTree &rtree)
{	
...
bool IParser::parse_nt( GrammarNonTerminal* non_term, AbstractParseTree& rtree)
{
...
bool IParser::parse_or(GrammarOrRule* or_rule, AbstractParseTree &rtree)
{
...
bool IParser::parse_rule(GrammarRule* rule, ParsedValue* prev_parts, const Ident tree_name, AbstractParseTree &rtree)
{   bool optional,
         sequential;
    ...
    last_fail_pos = &rule->last_fail_pos;
...
bool IParser::parse_seq(GrammarRule* rule, const char *chain_sym,
...
ParseSolution* IParser::find_solution(unsigned long filepos, Ident nt)
{
	ParseSolution* sol;
...
void IParser::expected_string(const char *s, bool is_keyword)
{
	AbstractParser::expected_string(_text, s, is_keyword);
}

bool IParser::parse(const TextFileBuffer& textBuffer, Ident root_id, AbstractParseTree& result)
{
	_depth = 0;
	_text = textBuffer;
	_f_file_pos = _text;
	...
	bool try_it = parse_nt(find_nt(root_id), result);
